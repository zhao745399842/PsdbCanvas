...
(function(){
    ...
    //指定类的继承关系
    var p = createjs.extend(SwitchingStationNode, PsdbCanvas.StationNode);
    /**
     * 绘制图形
     */
    ...
    PsdbCanvas.SwitchingStationNode = createjs.promote(SwitchingStationNode, "StationNode");
})();